...
interface GLSLHillsProps {
  /** RGB each 0–1. Defaults to warm sand that reads on cream #fdf8f3 */
      ...
      new THREE.RawShaderMaterial({
        ...
        vertexShader: `
          ...
          void main(void){
            ...
            float s=sin(radians(pos.x/128.0*90.0));
            vec3 np=pos+vec3(0.0,0.0,time*-30.0);
            float n1=cnoise(np*0.08);
            float n2=cnoise(np*0.06);
            float n3=cnoise(np*0.4);
            vec3 lp=pos+vec3(0.0,
        ...
        fragmentShader: `
          ...
          void main(void){
            ...
            gl_FragColor=vec4(uColor,max(opacity,0.0));
          }
        `,
      })
    );
